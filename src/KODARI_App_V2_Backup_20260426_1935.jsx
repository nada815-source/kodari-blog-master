...
function App() {
	...
	const handleDownloadBackup = async () => {
		try {
			...
			const now = new Date();
			const kstDate = new Date(now.getTime() + 9 * 60 * 60 * 1e3).toISOString().replace(/T/, "_").replace(/[:.-]/g, "").slice(0, 15);
...
import * as __vite_react_currentExports from "/src/App.jsx?t=1777199707690";
